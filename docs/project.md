...
npm run soundtrack-corner-report  # Curated Soundtrack Corner coverage snapshot
npm run sync-crate-digger-knowledge # Refresh hosted Crate Digger knowledge store

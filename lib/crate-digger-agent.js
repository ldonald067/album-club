...
import { moderateChatPrompt } from "@/lib/chat-moderation";
...
const KNOWLEDGE_INTENT_BOOSTS = [
  ...
  {
    filename: "screen-and-forum-reference-bank.md",
    patterns: [
      /\b(?:movie|film|tv|show|prestige|montage|needle drop|cold open|pilot|thread|forum|post|reply|opener)\b/i,
    ],
  },
];
const CHAT_REPLY_MODES = [
  ...
  },
  {
    key: "soundtrack",
    patterns: [
      /\b(?:soundtrack|ost|game|games|boss|level|menu|overworld|ending|credits|movie|film|tv|show|prestige)\b/i,
    ],
    guidance: [
      "Reply mode: soundtrack bridge.",
      "Answer in scene language and sensory detail.",
      "Do not say only 'vibes.' Name the kind of scene, motion, camera, room, or game space.",
    ],
  },
  {
    key: "debate",
...
const MODE_KNOWLEDGE_PREFERENCES = {
  ...
  soundtrack: [
    "soundtrack-taxonomy.md",
    "game-pop-culture-bridges.md",
    "screen-and-forum-reference-bank.md",
    "scene-pocket-guides.md",
  ],
  debate: [
